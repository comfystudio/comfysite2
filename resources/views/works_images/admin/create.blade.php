    ...
    <div id="page-content">
                ...
                <div class="col-sm-6 hidden-xs">
                    <div class="header-section">
                        <ul class="breadcrumb breadcrumb-top">
                            <li><a href="/admin/works-images/{{$works->id}}/">Work Image</a></li>
        ...
        <div class="block">
            ...
            <div class="block-title">
                <h2>@if(isset($data)) Edit @else Add @endif Work Image</h2>
            </div>
            ...
            <form action="/admin/works-images/{{$works->id}}/{{isset($images) ? 'edit/'.$images->id : 'create'}}" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="col-md-10 double-input">
                            ...
                            <div class="col-xs-6">
                                <div class="edit-download-wrap">
                                    <a href="/admin/works-images/{{$works->id}}/download/{{$images->id}}/" class="btn btn-primary">Download Current Work Image <i class="fa fa-cloud-download"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group @if($errors->has('image')) error @endif ">
                    <label class="col-md-2 control-label" for="file">Work Image <span class="text-danger">*</span></label>
                    <div class="col-md-5">
